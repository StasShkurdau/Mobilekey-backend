...
import com.mobilekey.backend.generated.keys.USER_EMAIL_KEY
import com.mobilekey.backend.generated.keys.USER_LOGIN_KEY
import com.mobilekey.backend.generated.keys.USER_PKEY
...
open class User(
     ...
     */
    val LOGIN: TableField<UserRecord, String?> = createField(DSL.name("login"), SQLDataType.VARCHAR(255).nullable(false), this, "")
    ...
    override fun getUniqueKeys(): List<UniqueKey<UserRecord>> = listOf(USER_EMAIL_KEY, USER_LOGIN_KEY)
